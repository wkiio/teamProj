            ...
            <form enctype="myltipart/form-data" >
               <div class="modal-body">
                     <div class="form-group">
                       <input type="file" class="form-control123" id="photoinput" onChange="getname(this);">
                       <small></small>
                      </div>
               </div>
            </form>
...
{ 
   ...
   var fileObj = document.getElementById("photoinput").files[0].name;
    //fileObj.dynsrc.value = obj.value; 
    console.log('파일은?' + fileObj);
   // console.log('ff');
