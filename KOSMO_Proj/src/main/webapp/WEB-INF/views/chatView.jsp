...
<div class="site-section" style="height:auto; padding:2em;z-index=3" >
	...
	<fieldset>
			...
			<h2>대화 영역</h2>
				...
				<div id="chatArea">					
					<div class="col-md-8" id="chatMessage"	style="height: 300px; border: 1px gray solid;overflow:auto"></div>
				</div>
...
<script>
  		...
  		$(function(){
  			...
  			wsocket= new WebSocket("ws://192.168.0.60:8080<c:url value='/echo.kosmo'/>")
			wsocket.onopen = open;
