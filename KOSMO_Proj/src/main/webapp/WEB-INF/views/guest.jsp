   ...
   var displayComments = function(data) {
      ...
      $ .each(data,function(index, comment) {
                     ...
                     */
                     ...
                     commentsString += "<div style='margin-left: 60px;width:300px;'>";
                     if(comment['image'] != "noneImage"){
                     commentsString += "<img id='commentImg' style='width:100px;height:100px;margin-top: -20px;margin-bottom:15px;' src=\"<c:url value='/upload/"+comment["image"]+"'/>\" alt=\"이미지댓글\" style='cursor: pointer;'/>";
                     //commentsString +="'"+$('#commentImg').attr('src',comment['image'])+"'";
                     }
                     commentsString += "</div><div style='margin-top: -15px;margin-left: 75px;width:300px;'><span style='margin-left:-25px;cursor:pointer' class='commentEdit' title='"+comment['gNo']+"'>"
