    ...
    t.cleanData = function(e) {
        ...
        function() {
            ...
            t.position = {
                    ...
                    n = t.extend({}, n);
                    var p, m, g, _, v, b, y = t(n.of),
                        w = t.position.getWithinInfo(n.within),
                        k = t.position.getScrollInfo(w),
                        x = (n.collision || "flip").split(" "),
                        C = {};
                    return b = s(y), y[0].preventDefault && (n.at = "left top"), m = b.width, g = b.height, _ = b.offset, v = t.extend({}, _), t.each(["my", "at"], function() {
                    ...
                    }), 1 === x.length && (x[1] = x[0]), "right" === n.at[0] ? v.left += m : "center" === n.at[0] && (v.left += m / 2), "bottom" === n.at[1] ? v.top += g : "center" === n.at[1] && (v.top += g / 2), p = e(C.at, m, g), v.left += p[0], v.top += p[1], this.each(function() {
                        var s, h, c = t(this),
                            u = c.outerWidth(),
                            d = c.outerHeight(),
                            f = i(this, "marginLeft"),
                    ...
                    flip: {
                        ...
                        top: function(t, e) {
                            var i, s, n = e.within,
                                ...
                                m = -2 * e.offset[1];
                            0 > c ? (s = t.top + p + f + m + e.collisionHeight - a - o, (0 > s || r(c) > s) && (t.top += p + f + m)) : u > 0 && (i = t.top - e.collisionPosition.marginTop + p + f + m - l, (i > 0 || u > r(i)) && (t.top += p + f + m))
                        }
                    },
                    flipfit: {
                        left: function() {
