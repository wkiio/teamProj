...
public class GuestBookController {
	...
	public String list(@RequestParam Map map) throws Exception{
		...
		for(Map comment:comments) comment.put("GPOSTDATE", comment.get("GPOSTDATE").toString().substring(0,10));
	...
	public String reply(@RequestParam Map map) throws Exception{
		System.out.println("답변시작");
		int affected =guestBookService.reply(map);
		
		System.out.println("답변 끝");
		return "foward:/GuestBook/List.kosmo";
	}//////////////////////
