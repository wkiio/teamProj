...
public class GuestBookController {
   ...
   public String list(@RequestParam Map map) throws Exception{
      ...
      */
      ...
      for(GuestBookDTO comment:comments) { 
         ...
         System.out.println("asdasdasdasd"+comment.getImage());
   ...
   public String write(@RequestParam Map map,Authentication auth, MultipartHttpServletRequest mhsr) throws Exception{
      ...
      if(mhsr.getFile("image") != null){
         ...
         System.out.println("null 아닌거 시작2");
         if(upload != null) {
         System.out.println("null 아닌거 시작3");
         String newFileName=FileUpDownUtils.getNewFileName(phisicalPath, upload.getOriginalFilename());
         System.out.println("null 아닌거 시작4");
   ...
   public String update(@RequestParam Map map, MultipartHttpServletRequest mhsr) throws Exception{
